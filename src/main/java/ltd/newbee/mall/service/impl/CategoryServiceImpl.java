...
public class CategoryServiceImpl implements CategoryService {
    ...
    public PageResult getCategorisPage(PageQueryUtil pageUtil) {
        ...
        //总记录数
        int totalGoodsCategories = goodsCategoryMapper.getTotalGoodsCategories(pageUtil);
        PageResult pageResult = new PageResult(goodsCategories, totalGoodsCategories, pageUtil.getLimit(), pageUtil.getPage());
        return pageResult;
    }
